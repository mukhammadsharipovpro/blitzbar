...
import BlitzBarCartItemComponent from '../components/BlitzBarCartItemComponent';
import BlitzBarComponent from '../components/BlitzBarComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <BlitzBarCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
